...
from api.rest.pipeline_components import FeatureExtractor
from data.loaders.audio_utils import normalize_waveform, segment_audio
from models.model_loader import get_hubert_model_and_processor, DEVICE
from models.backbone.physics_features import VoiceRadarInspiredDynamics
...
try:
    ...
    from models.ensemble.utils.bayesian_config_loader import load_bayesian_config
    ...
    def __init__(self, enable_cache: bool = True, cache_dir: str = "cache",
        ...
        try:
            ...
            if _device_context is not None:
                ...
                from models.model_loader import device_context
...
class FeatureExtractorFactory:
    ...
    def create(
        ...
        if model_loader is None:
            from models.model_loader import get_hubert_model_and_processor
        ...
        if device_context is None:
            from models.model_loader import device_context as default_device_context
