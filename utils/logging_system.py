...
class ProjectLogger:
    ...
    def setup_directories(self):
        """Create and setup all logging directories using standardized structure."""
        # Get the deepfake-detection root directory (parent of scripts)
        ...
        self.dirs = {
            'output': self.project_root / 'output',  # Keep local to scripts for backwards compatibility
            'logs': self.project_root / 'logs',      # Keep local to scripts for backwards compatibility
            'checkpoints': root_dir / 'results' / 'checkpoints',  # Use standardized checkpoints
            'plots': root_dir / 'inference' / 'visualization',     # Use standardized visualization
            'results': root_dir / 'results',         # Use standardized results
        }
